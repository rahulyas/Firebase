...
import com.apogee.firebase.databinding.ActivityUpdateBinding;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle != null){
            ...
            binding.updateTopic.setText(bundle.getString("dataTitle"));
            binding.updateLang.setText(bundle.getString("dataLang"));
            binding.updatedescription.setText(bundle.getString("dataDesc"));
...
//Firebase Tutorials is the table name
        databaseReference = FirebaseDatabase.getInstance().getReference("Firebase Tutorials").child(key);
        ...
        binding.updatedButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                saveData();
            }
    ...
    public void uploadData(){
        String title = binding.updateTopic.getText().toString().trim();
        String description = binding.updatedescription.getText().toString().trim();
        String lang = binding.updateLang.getText().toString().trim();
